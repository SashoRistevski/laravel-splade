    ...
    <x-slot name="header">
        <div class="flex justify-between">
            ...
            <Link href="{{ route('posts.create') }}"
                  class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded"> Create Post
            </Link>
        </div>
    </x-slot>
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <x-splade-table :for="$posts">
                ...
                <Link class="bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-4 rounded ml-2"
                      ...
                      cancel-button="Cancel" href="{{route('posts.destroy', $post->id)}}" method="DELETE"
                      preserve-scroll>
                    Delete
                </Link>
                @endcell
